    ...
    <View style={styles.container}>
      ...
      <View style={styles.optionsContainer}>
        ...
        <TouchableOpacity
          style={[
            styles.optionButton,
            selectedFilter === "scooters" && styles.selectedButton,
          ]}
        ...
        >
          <Text
            style={[
              styles.optionText,
              selectedFilter === "scooters" && styles.selectedText,
            ]}
          >
            Scooters (2 Wheels)
          </Text>
        ...
        <TouchableOpacity
          style={[
            styles.optionButton,
            selectedFilter === "cars" && styles.selectedButton,
          ]}
        ...
        >
          <Text
            style={[
              styles.optionText,
              selectedFilter === "cars" && styles.selectedText,
            ]}
          >
            Cars (4 Wheels)
          </Text>
